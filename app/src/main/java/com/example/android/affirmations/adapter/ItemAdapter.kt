...
import com.example.android.affirmations.model.Affirmations
...
class ItemAdapter(private val context: Context, private val dataset: List<Affirmations>): RecyclerView.Adapter<ItemAdapter.ItemViewHolder>() {
    ...
    class ItemViewHolder(private val view: View): RecyclerView.ViewHolder(view){
        val textVew: TextView = view.findViewById(R.id.item_title)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.textVew.text = context.resources.getString(item.stringResourceId)
